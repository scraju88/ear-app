...
patient = str(35)
os.chdir('C:/Users/SCRAJU88/Documents/Main Docs/Life Stuff/Product Ideas/Pediabyte/Smartphone Reflectometry/Data/Test Data/Test ' + patient);
    
bottomLeft = sorted(glob.glob('*-Poscontrol*.dat')) #enables you to find files with a particular tag line *the asterisk denotes that there are values before or after it
