...
os.chdir('C:/Users/SCRAJU88/Documents/Main Docs/Life Stuff/Product Ideas/Pediabyte/Smartphone Reflectometry/Data/Test Data/Patient 32/iPhone');
...
plt.title('iPhone for Patient ' + title1[18:20]) #takes number from file name
fig = plt.gcf() #this line is required to show figure 
fig.savefig('iPhone for Patient ' + title1[18:20] + '.png') #these lines are required to show figure
plt.show() #shows plot
